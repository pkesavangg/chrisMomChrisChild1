...
struct RegisterView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            VStack{
                    ...
                    VStack(alignment: .leading, spacing: 20)  {
                        ...
                        VStack(alignment: .leading){
                            ...
                            VStack(alignment: .leading){
                                ...
                                SecureField("7845*wdK" , text: $passwordFieldValue)
                        ...
                        VStack(alignment: .leading){
                            ...
                            VStack(alignment: .leading){
                                ...
                                SecureField("7845*wdK" , text: $confirmPasswordFieldValue)
                ...
                Spacer()
                NavigationLink("", destination: DashboardView(isDashboardView: $authentication.isLoggedIn ), isActive: $authentication.isLoggedIn)
    ...
    private func register() {
        if(isRegisterFormValid){
            authentication.register(email: self.emailFieldValue, password: self.passwordFieldValue)
            gameService.sendUserDetails(userId: self.emailFieldValue, userName: self.usernameFieldValue)
        }
